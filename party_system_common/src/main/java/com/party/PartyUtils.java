...
public class PartyUtils {
    ...
    /**
     * 判断   集合   是否有效   list set 是collection的接口
     *
...
//            throw new RuntimeException(AgricultureConstant.MESSAGE_CODE_INVALID);
//        }
//
//        // 声明StringBuilder待用
...
//
//            // 遍历outputBytes，一个字节8bit  4个二进制数代表一个16进制数
//            for (int i = 0; i < outputBytes.length; i++) {
//
//                // 获取当前字节数值
//                byte b = outputBytes[i];
//
//                // 获取低四位值，与运算是2进制去运算 ，返回给value的是十进制的
//                int lowValue = b & 15;
//
//                // 右移四位和15做 与运算 得到高四位值
//                int highValue = (b >> 4) & 15;
//
//                // 以高四位、低四位的值为下标从字符数组中获取对应  字符
